...
public class Program{
    ...
    public static void programMenu(Scanner input, ArrayList<Figures> allFigure) {
        ...
        System.out.println("4. Вывода информации о всех периметах, площадях и длиннах окружности всех фигур, если возможно");
        System.out.println("5. Удалить фигуру");
    ...
    private static void createSquare(Scanner input, ArrayList<Figures> allFigure) {
        ...
        System.out.print("Введите сторону a: ");
        Double a = input.nextDouble();
        allFigure.add(new Sqaure(name, a));
